                  ...
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {`Təşəkkür edirəm ki mənim vəkilim oldunuz. Sizinlə işləmək çox təşəkkürkar bir təcrübə idi. Sizin dəstəyiniz və profesionallığınızdan son dərəcə məmnun qaldım.`}
                        </p>
                      </blockquote>
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {`İşgüzar nüfüzumun müdafiəsi üçün vəkil Elnur Quliyevə təşəkkür edirəm. Sizin dəstəyiniz və məsləhətləriniz çox qiymətli oldu. Hər zaman əla xidmətinizə görə minnətdaram.`}
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        <span
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {`Əmlak sahibkarlığımı qorumaq üçün verdiyiniz dəstək üçün təşəkkür edirəm. Sizin təklif və məsləhətləriniz mənim üçün çox faydalı oldu. Sizi məsuliyyətli və profesionallıqla işlədiyiniz üçün tərifləmək istəyirəm.`}
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        <span
                ...
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          {`Ailəmin hüquqlarını müdafiə etmək üçün göstərdiyiniz dəyərli dəstəyə görə minnətdaram. Sizin səmərəli və məsuliyyətli işiniz sayəsində mən və ailəm üçün əlverişli bir nəticə əldə etdik. Hər bir mərhələdə bizə yaxın duraraq və məsləhət verərək, məhkəmə prosesində bizə rahatlıq hissi verməyinizə çox minnətdaram.`}
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        <span
